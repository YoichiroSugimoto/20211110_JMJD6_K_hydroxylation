---
title: "p-1. Protein feature extraction (1/2)"
...
ind.fa.dir <- file.path(j.p.res.dir, "individual_fastas")
iupred2.dir <- normalizePath(file.path(j.p.res.dir, "IUPred2_score"))
...
fwrite(
    max.iupred2.dt,
    file.path(j.p.res.dir, "Max_IUPRED2_per_protein.csv")
)
